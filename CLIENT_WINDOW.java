...
public class CLIENT_WINDOW extends javax.swing.JFrame {
    ...
    {
        //here i have copy and pasted it from owner to client. that's why their variable name are same. 
        P_CLIENT owner = new P_CLIENT();
        ArrayList<P_CLIENT> ownersList = owner.ownerList();
    ...
    private void jButton_Add_OwnerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Add_OwnerActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Enter the Required fields [first name, last name, phone and address]", "Add Client", 2);
        }
        else
        {
            if(owner.addNewClient(new P_CLIENT(0, fname, lname, phone, email, address)))
            {
    ...
    private void jButton_Edit_OwnerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit_OwnerActionPerformed
        ...
        try
        {
            ...
            {
                if(owner.editClientData(new P_CLIENT(ownerId, fname, lname, phone, email, address)))
                {
                    JOptionPane.showMessageDialog(null, "Client Data Edited", "Edit Client", 1);
                }
                else
                {
                    JOptionPane.showMessageDialog(null, "Client Not Edited To The System", "Edit Client", 2);
